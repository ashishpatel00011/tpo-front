...
const Logic = ({ token }) => {
    ...
    useEffect(() => {
        async function fetchProblems() {
            ...
            const filteredProblems = data.filter((problem) => problem.type === "logical");
    ...
    <div className="dropdown">
      <button onClick={toggleDropdown} className={`dropbtn ${isOpen ? 'active' : ''}`}>
        <div className="progress-bar-container" style={{ marginTop: '5px', marginBottom: '7px', width: '100%' }}>
          <div
            ...
            style={{
              ...
              backgroundColor: 'red', // Change to the desired color for logic
              height: '5px',
              borderRadius: '5px',
            }}
          />
        ...
        <div className="buttoncontent">
          <div className='title'>Logical Thinking</div>
          <div className='dbtn'>
