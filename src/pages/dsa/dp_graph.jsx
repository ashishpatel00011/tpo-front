    ...
    useEffect(() => {
      async function fetchProblems() {
          try {
              ...
              const filteredProblems = data.filter((problem) => problem.type === "dp");
  ...
  return (
    <div className="dropdown">
      <button onClick={toggleDropdown} className={`dropbtn ${isOpen ? 'active' : ''}`}>
        <div className="progress-bar-container" style={{ marginTop: '5px', marginBottom: '10px', width: '100%' }}>
          <div
        ...
        <div className='buttoncontent'>
          <div className='title'>Important Graph & Dynamic Programming</div>
          <div className='dbtn'>
