...
import { Addproblem,getproblemsaved,Deleteproblem } from '../../api/add_dsa';
const String = ({ token }) => {
  ...
  useEffect(() => {
    async function fetchProblems() {
        try {
            ...
            const filteredProblems = data.filter((problem) => problem.type === "string");
  ...
  return (
    <div className="dropdown">
      ...
      >
        ...
        Strings
        <div className='dbtn'>
          {checkedCount}/{problems.length} {/* Show checked problems count */}
